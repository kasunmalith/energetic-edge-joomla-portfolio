...
class JFormFieldRH_Wrapper extends JFormField
{
    ...
    protected function getInput()
    {
                        ...
                        <nav class="rh_navbar">
                            <div class="rh_navbar-header bg-darker">
                                <a class="rh_navbar-icon rh_text-brand">
                                    <span class="rh_icon_text">tagz</span>
                                </a>
                            </div>
                            <a href="http://www.roosterz.nl" target="_blank" id="rh_logo_full" class="rh_logo fadeInTopBig animated_slow"></a>
                            <a href="index.php?option=com_tagz" id="rh_tagz_stats"><i class="rh_icon-stats"></i><span>statistics</span></a>
                        </nav>
                    </header>';
        ...
        else if ( (substr(JVERSION,0,1) == "3") || (substr(JVERSION,0,1) == "4") || (substr(JVERSION,0,1) == "5") ) // Joomla 3.x, 4.x or 5.x
        {
            ...
            {
                $html[] = '</div>';
                $html[] = '<div id="rh_wrapper_outer"><div id="rh_wrapper" class="'  . $class . '">';
                $html[] = '
                    <header class="rh_header">
                        <nav class="rh_navbar">
                            <div class="rh_navbar-header bg-darker">
                            ...
                            <a href="http://www.roosterz.nl" target="_blank" id="rh_logo_full" class="rh_logo fadeInTopBig animated_slow"></a>
                            <div id="rh_tagz_stats">
                                <a href="index.php?option=com_tagz" title="Statistics"><i class="rh_icon-stats"></i></a>
                                <a href="index.php?option=com_tagz&view=shortcodes" title="Shortcodes"><i class="rh_icon-code"></i></a>
                            </div>
                        </nav>
                    </header>';
