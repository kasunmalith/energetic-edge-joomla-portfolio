...
if($categoryId==17){
	//this is for the general article view
	
	?>
	<div class="com-content-article item-page<?php echo $this->pageclass_sfx; ?> general_article">
    ...
    <div class="com-content-article__body">
    	<?php 
    	  	$article_hits = $this->item->hits;
			$article_hits;
			  ?>
    	  <div class="page-header"><div class="new-article-label"><h2 class="sppb-addon-title"><span>New</span>Photo Album</h2>
    	  	<h2 class="sppb-addon-title"><span>Views</span><?php 
    	  	$article_hits=$article_hits+545;
    	  	echo $article_hits; ?></h2>
    	  </div>
        <<?php echo $htag; ?>>
            <?php echo $this->escape($this->item->title); ?>
        </<?php echo $htag; ?>>
