    ...
    <div id="fixed_top_area">
      ...
      <main>
      	<div class="sp-column ">
      		...
      		<div class="intro">Fusing web solutions, creative expertise & cutting-edge photography, cinematography for your success.</div>
...
?>
 ...
 <div id="quotation-event" class="visible">
 	<a href="<?php echo $root_address; ?>/contact-us">	Request Quotation for My Event</a> 
